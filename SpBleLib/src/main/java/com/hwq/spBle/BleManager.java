...
import com.hwq.spBle.bluetooth.BleBluetooth;
...
import com.hwq.spBle.exception.hanlder.DefaultBleExceptionHandler;
...
public class BleManager {
    ...
    public boolean writeDevice(String uuid_service,
                               ...
                               byte[] data,
                               BleCharacterCallback callback) {
        Log.e("--BleManager--", "当前发送数据：" + Arrays.toString(data));
        return bleBluetooth.newBleConnector()
